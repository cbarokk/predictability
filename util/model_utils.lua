...
function model_utils.clone_many_times(net, T)
    ...
    local params, gradParams, paramsNoGrad
    if net.parameters then
        params, gradParams, paramsNoGrad = net:parameters()
        if params == nil then
            params = {}
        end
    end
    ...
    --[[
    local paramsNoGrad
    print ("net.parametersNoGrad", net.parametersNoGrad())
    if net.parametersNoGrad then
        paramsNoGrad = net:parametersNoGrad()
    end
    ]]--
    --print ("noGradParams", noGradParams, gradParams)
    ...
    for t = 1, T do
        ...
        reader:close()
        if net.parameters then
            local cloneParams, cloneGradParams, cloneParamsNoGrad = clone:parameters()
            ...
            --local cloneParamsNoGrad = clone:parametersNoGrad()
